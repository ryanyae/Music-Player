...
//
//
//        songTest4 = new Song(artistTest1, "Awaken", "stub");
//        albumTest3 = new Album(artistTest1, "Awaken Album");
//        albumTest3.addToListOfSongs(songTest4);
//        artistTest1.newAlbumsMade(albumTest3);
//
//
//        songTest3 = new Song(artistTest2, "Levitating", "stub");
//        songTest5 = new Song(artistTest2, "Future Nostalgia", "stub");
...
//        assertEquals(albumTest1.getAlbumSize(), 1);
//        assertEquals(albumTest1.getAlbumTitle(), "Legends Album");
//
...
//        assertEquals(albumTest4.getAlbumSize(), 2);
//        assertEquals(albumTest4.getAlbumTitle(), "Future Nostalgia");
//    }
//
//    @Test
...
//        assertEquals(albumTest1.getAlbumSize(), 2);
//
//        albumTest4.addToListOfSongs(songTest2);
//        assertTrue(albumTest4.getListOfSongs().contains(songTest2.getTitle()));
//        assertTrue(albumTest4.getListOfSongs().contains(songTest3.getTitle()));
//        assertTrue(albumTest4.getListOfSongs().contains(songTest5.getTitle()));
//        assertFalse(albumTest4.getListOfSongs().contains(songTest4.getTitle()));
//    }
//
//    @Test
